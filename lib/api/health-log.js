...
async function findTodayHabitsPage() {
  ...
  /*
   * Fallback: use a page created today.
   */
  const today =
    getTodayDate();
...
export default async function healthLogHandler(
  ...
  try {
    ...
    /*
     * Only walking checks off
     * a Daily Habits property.
     *
     * Water continues to behave
