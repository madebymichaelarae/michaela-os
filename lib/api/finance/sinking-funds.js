...
const currentBalance = Math.abs(
 ...
 /*
 * Do not clamp this value to zero.
 *
 * Positive = amount still needed
 * Zero     = goal reached exactly
 * Negative = amount saved beyond the goal
 */
const remaining =
  goalAmount -
  currentBalance;
...
/*
 * Calculate progress from the normalized positive balance
 * instead of using the Notion formula, which still reflects
