...
function normalizeWaterToOz(
  ...
  /*
   * Your Notion category is "💧 Water",
   * so do not require an exact match.
   */
  if (
    !category.includes(
      "water"
  ...
  /*
   * If the unit is ever missing, keep the
   * numeric amount rather than silently
   * throwing away the hydration entry.
   */
  return amount;
}
/* =========================================================
